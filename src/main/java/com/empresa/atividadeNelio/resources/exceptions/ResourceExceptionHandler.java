package com.empresa.atividadeNelio.resources.exceptions;
...
import com.empresa.atividadeNelio.services.exceptions.JWTAuthenticationException;
import com.empresa.atividadeNelio.services.exceptions.JWTAuthorizationException;
import com.empresa.atividadeNelio.services.exceptions.ParamFormatException;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> validation(MethodArgumentNotValidException e, HttpServletRequest request){
		...
		for(FieldError it: e.getBindingResult().getFieldErrors()) {
			err.addError(it.getField(), it.getDefaultMessage());
		}
